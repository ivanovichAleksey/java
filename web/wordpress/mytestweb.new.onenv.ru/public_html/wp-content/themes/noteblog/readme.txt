...
- Fixed: Header now doesnt require a specific size
...
- Added: Noteblog about page
- Added: Noteblog F.A.Q and documentation
- Changed: Header title is now custom is not the website title
- Changed: Header description is now custom and not the website tagline
